...
/**
 * This bot handles actions related to trading, such as adding items to the trade window or
 * outputting user-specified messages while playing in a trade server
 */
